...
// void adicionarParenteses(char expressao[], int inicio, int fim) //nao funciona
// {
...
// void converterPosfixaParaInfixa(char expressaoPosfixa[], char expressaoInfixa[]) //nao funciona
// {
//     Pilha pilha;
//     inicializar(&pilha);
